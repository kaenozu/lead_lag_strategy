...
function isTradingDay(date, market = 'JP') {
  ...
  if (market === 'US') {
    ...
    if (month === 1 && day >= 15 && day <= 21 && day === 1) return false;
    // Presidents Day (3rd Monday of February)
    if (month === 2 && day >= 15 && day <= 21 && day === 1) return false;
    // Memorial Day (last Monday of May)
    if (month === 5 && day >= 25 && day === 1) return false;
    // Independence Day
    if (month === 7 && dayOfMonth === 4) return false;
    // Labor Day (1st Monday of September)
    if (month === 9 && day <= 7 && day === 1) return false;
    // Thanksgiving (4th Thursday of November)
    if (month === 11 && day >= 22 && day <= 28 && day === 4) return false;
    // Christmas
  ...
  if (market === 'JP') {
    ...
    if (month === 1 && day >= 8 && day <= 14 && day === 1) return false;
